...
void DArray::SetSize(int nSize) {
	...
	delete[]m_pData;         //delete the array pointer m_pData
	m_pData = pData;
	delete[]pData;
	m_nSize = nSize;
}
...
void DArray::PushBack(double dValue) {
	double* pTemp = new double[static_cast<size_t>(m_nSize) + 1]; //static_cast<typename>(m_nSize)强制转换；size_t是unsigned int
